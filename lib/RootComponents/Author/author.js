...
import GET_AUTHOR_QUERY from '../../queries/getAuthorQuery.graphql';
...
import defaultClasses from './author.css';
...
const AuthorPage = props => {
	...
	const {meta_title, meta_description, title} = authorData.blogAuthor;

	const authorLabel = formatMessage({
		id: 'mfBlog.authorLabel',
